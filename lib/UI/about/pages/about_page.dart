                          ...
                          children: [
                            Transform(
                              transform: Matrix4.identity()
                                ...
                                ..rotateZ(0.14),
                              child: Container(
                                width: MediaQuery.sizeOf(context).width * 0.280,
                                height:
                                ...
                                padding: EdgeInsets.only(
                                  ...
                                  left:
                                      MediaQuery.sizeOf(context).width * 0.0135,
                                ...
                                child: Container(
                                  width:
                                      MediaQuery.sizeOf(context).width * 0.273,
                                  height:
                                      MediaQuery.sizeOf(context).height * 0.275,
                                  clipBehavior: Clip.antiAlias,
                                  decoration: const BoxDecoration(
                            ...
                            Padding(
                              ...
                              child: Container(
                                width: MediaQuery.sizeOf(context).width * 0.081,
                                height:
